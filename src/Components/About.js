    ...
    <section id="about">
      <Container className="py-5">
        <Row className="align-items-center">
          ...
          <Col lg={6} md={6}>
              <img src="images/mario-adrian.jpg" alt="Mario and Adrian" className="image img-1" />
              <img src="images/restaurant-chef.jpg" alt="Restaurant chef" className="image img-2" />
          </Col>
        </Row>
      </Container>
    </section>
